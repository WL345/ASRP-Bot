...
from config import TRUSTED_VIP_LOGGING_CHANNEL
...
class TrustVIPCog(discord.ext.commands.Cog):
    ...
    async def trustvip(self, interaction: discord.Interaction, user: discord.User, reason: str, trustvip: str):
        if trustvip == "vip":
            if "Management Team" in interaction.user.roles or self.bot.get_guild(1182487341386969158).get_role(1355375890984341524) in interaction.user.roles:
...
> Check out your perks in https://discord.com/channels/1182487341386969158/1182828152259608598 and enjoy!""",
                ...
                try:
                    ...
                    await self.bot.get_channel(TRUSTED_VIP_LOGGING_CHANNEL).send(embed=log_embed)
