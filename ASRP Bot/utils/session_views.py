import traceback, discord, config, toml
from config import *
...
class FinalLogConfirmation(discord.ui.View):
    ...
    @discord.ui.button(label="Confirm", style=discord.ButtonStyle.green, custom_id="session_logging")
...
class SSUModal(discord.ui.Modal, title="SSUers"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        """,
            ...
            msg = await channel.fetch_message(data["sessions"]["message_id"])
            ...
            data["sessions"]["message_id"] = ssu_msg.id
...
class SSDModal(discord.ui.Modal, title="SSD Reasoning"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        try:
            ...
            await msg.delete()
            ssd_msg = await self.bot.get_channel(config.channels.SERVER_STATUS).send(embed=embed)
            ...
            data["sessions"]["message_id"] = ssd_msg.id
            with open("storage/misc.toml", "w") as f:
                toml.dump(data, f)
